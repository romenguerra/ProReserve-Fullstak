    ...
    <MainLayout title="{{ $t('beauty.section_title') }} y Belleza - ProReserve">
        ...
        <section class="relative min-h-[40vh] flex items-center overflow-hidden bg-[#FEF2F2]">
            <div class="absolute inset-0 opacity-70" style="
                ...
                background-image: 
                    radial-gradient(at 0% 0%, #FECDD3 0px, transparent 50%),
                    radial-gradient(at 100% 0%, #FBCFE8 0px, transparent 50%),
                    radial-gradient(at 50% 100%, #FDA4AF 0px, transparent 50%);
                filter: blur(40px);
            "></div>
        ...
        <!-- Beauty Grid -->
        <section class="bg-[#FEF2F2] pt-12 pb-24 min-h-screen">
            <div class="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
                ...
                <!-- Grid -->
                <div v-if="beautyCenters.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-16">
                    <BeautyCard 
                        v-for="(center, index) in beautyCenters" 
                        :key="center.id" 
                        :center="center"
                        :index="index"
                ...
                <div v-if="beautyCenters.length > 0" class="mt-24 flex">
                    <Link 
                        href="/"
