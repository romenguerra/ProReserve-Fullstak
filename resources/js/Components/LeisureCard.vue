        ...
        <div @click="$emit('open-modal', center)" class="block">
            ...
            >
                ...
                <div class="absolute bottom-4 left-4">
                    <span class="bg-indigo-900/60 backdrop-blur-md text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border border-white/10">
            ...
            <div class="px-2">
                <div class="flex justify-between items-start mb-2">
                    <h3 class="text-2xl font-bold text-gray-900 leading-tight group-hover:text-indigo-600 transition-colors duration-300">
                        {{ center.name }}
                    </h3>
                </div>
