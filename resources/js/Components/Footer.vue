<template>
    <footer class="bg-[#0f172a] text-white border-t border-white/10">
        <div class="mx-auto max-w-7xl px-6 sm:px-12 lg:px-16 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div class="flex flex-col space-y-6">
                    ...
                    <p class="text-base text-gray-400 leading-relaxed max-w-sm">
                        Simplificando la gestión de tus reservas con tecnología
                        moderna y eficiente. Tu tiempo es valioso, nosotros te
                        ayudamos a optimizarlo.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <form @submit.prevent class="flex flex-col space-y-3">
                        <input
                            ...
                            class="bg-white/5 border-white/10 text-white rounded-xl focus:ring-[#8EB6A5] focus:border-[#8EB6A5] placeholder-gray-500 py-3 px-4 outline-none transition-all"
                        />
                        <button
                            type="submit"
                            class="bg-[#8EB6A5] hover:bg-[#7aa592] text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg shadow-[#8EB6A5]/10"
                        >
                            Suscribirse
                        </button>
                    </form>
            ...
            >
                <p class="text-sm text-gray-500">
                    &copy; {{ currentYear }} ProReserve. Todos los derechos
                    reservados.
                </p>
