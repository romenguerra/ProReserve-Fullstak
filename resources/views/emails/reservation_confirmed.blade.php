...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                Te confirmamos que tu reserva ha sido gestionada correctamente. A continuación tienes los detalles de tu cita:
            </div>
            ...
            <div class="btn-container">
                <a href="{{ url('/reservas') }}" class="btn">Gestionar mis reservas</a>
            </div>
        </div>
        <div class="footer">
